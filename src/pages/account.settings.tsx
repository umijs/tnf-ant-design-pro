...
import BaseView from '@/components/Account/Settings/base';
import BindingView from '@/components/Account/Settings/binding';
...
import { queryCurrent } from '@/services/account/settings';
